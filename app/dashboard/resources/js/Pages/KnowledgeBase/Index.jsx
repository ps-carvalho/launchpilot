    ...
    return (
        <>
            ...
            <AppShell>
                ...
                {/* Upload Area */}
                <div
                    className={`mb-8 rounded-xl border-2 border-dashed p-8 text-center transition-all cursor-pointer shadow-elevation-1 hover:shadow-elevation-2 ${
                ...
                {documents.length === 0 ? (
                    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-line bg-white py-20 shadow-elevation-1">
                        ...
                        <Link href="/onboarding" className="mt-6 rounded-lg bg-ink px-5 py-2.5 text-sm font-bold text-white hover:bg-ink/90 shadow-elevation-1 hover:shadow-elevation-2 transition-all hover:-translate-y-0.5 inline-block">
                            Add your website
                        </Link>
                    </div>
                ) : (
